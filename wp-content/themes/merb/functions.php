...
add_action( 'after_setup_theme', 'merb_setup' );
 ...
 * @since Twenty Fifteen 1.0
 */
function merb_scripts() {
    // Add custom fonts, used in the main stylesheet.
    wp_enqueue_style( 'merb-fonts', twentyfifteen_fonts_url(), array(), null );

    // Add Genericons, used in the main stylesheet.
    wp_enqueue_style( 'genericons', get_template_directory_uri() . '/genericons/genericons.css', array(), '3.2' );

    // Load our main stylesheet.
    wp_enqueue_style( 'merb-style', get_stylesheet_uri() );

    // Load the Internet Explorer specific stylesheet.
    wp_enqueue_style( 'merb-ie', get_template_directory_uri() . '/css/ie.css', array( 'merb-style' ), '20141010' );
    wp_style_add_data( 'merb-ie', 'conditional', 'lt IE 9' );

    // Load the Internet Explorer 7 specific stylesheet.
    wp_enqueue_style( 'merb-ie7', get_template_directory_uri() . '/css/ie7.css', array( 'merb-style' ), '20141010' );
    wp_style_add_data( 'merb-ie7', 'conditional', 'lt IE 8' );

    wp_enqueue_script( 'merb-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20141010', true );
